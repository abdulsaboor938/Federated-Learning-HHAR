...
def load_data():
    user_one="C:\\pdata\\extrasensory_dataset\\1DBB0F6F-1F81-4A50-9DF4-CD62ACFA4842.features_labels.csv.gz"
...
model=load_model('1DSensoryCNN.h5',compile=False)
...
class CifarClient(fl.client.NumPyClient):
  ...
  def fit(self, parameters, config):
    ...
    print(model.fit(X_train, y_train, epochs=60, batch_size=32))
